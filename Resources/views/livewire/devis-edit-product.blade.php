        ...
        <div class="flex flex-wrap flex-col">
            ...
            <x-basecore::partials.card>
                <div class="w-full grid grid-cols-4">
                    ...
                    <x-basecore::inputs.group class="w-full">
                        <x-basecore::inputs.basic label="Point de départ" class='addressmap' data-trajet="{{$trajetId}}"
                                                  name="aller_point_depart" wire:model="trajet.aller_point_depart"
                                                  placeholder="Ville, adresse , ..."/>
                        <input type="hidden" name='aller_point_depart_geo_{{$trajetId}}'
                               wire:model="trajet.aller_point_depart_geo"/>
                    </x-basecore::inputs.group>
                    <x-basecore::inputs.group class="w-full">
                        <x-basecore::inputs.basic label="Point d'arriver" class='addressmap' data-trajet="{{$trajetId}}"
                                                  name="aller_point_arriver" wire:model="trajet.aller_point_arriver"
                                                  placeholder="Ville, adresse , ..."/>
                        <input type="hidden" name='aller_point_arriver_geo_{{$trajetId}}'
                               wire:model="trajet.aller_point_arriver_geo"/>
                    </x-basecore::inputs.group>
                    <x-basecore::inputs.group class="w-full">
                        <x-basecore::inputs.basic label="Pax" name="aller_pax" wire:model.lazy="trajet.aller_pax"
            ...
            <x-basecore::partials.card>
                <div class="w-full grid grid-cols-4">
                    <x-basecore::inputs.group class="w-full">
                        <x-basecore::inputs.datetime label="Date de départ" name="retour_date_depart"
                                                     wire:model.lazy="trajet.retour_date_depart"
                                                     placeholder="Date de départ"/>
                    </x-basecore::inputs.group>
                    <x-basecore::inputs.group class="w-full">
                        <x-basecore::inputs.basic label="Point de départ" class='addressmap' data-trajet="{{$trajetId}}"
                                                  name="retour_point_depart"
                                                  wire:model.lazy="trajet.retour_point_depart"
                                                  placeholder="Ville, adresse , ..."/>
                        <input type="hidden" name='retour_point_depart_geo_{{$trajetId}}'
                               wire:model="trajet.retour_point_depart_geo"/>
                    </x-basecore::inputs.group>
                    <x-basecore::inputs.group class="w-full">
                        <x-basecore::inputs.basic label="Point d'arriver" class='addressmap' data-trajet="{{$trajetId}}"
                                                  name="retour_point_arriver"
                                                  wire:model.lazy="trajet.retour_point_arriver"
                                                  placeholder="Ville, adresse , ..."/>
                        <input type="hidden" name='retour_point_arriver_geo_{{$trajetId}}'
                               wire:model="trajet.retour_point_arriver_geo"/>
                    </x-basecore::inputs.group>
                    <x-basecore::inputs.group class="w-full">
                        <x-basecore::inputs.basic label="Pax" name="retour_pax" wire:model.lazy="trajet.retour_pax"
                                                  placeholder="Nombre de passagers"/>
                    </x-basecore::inputs.group>
                </div>
            </x-basecore::partials.card>
            ...
            <x-basecore::partials.card>
                <div class="grid grid-cols-3">
                    @foreach($brands as $brand)
                        <x-basecore::inputs.group>
                            <x-basecore::inputs.number label="{{$brand->label}}" name=""
                                                       wire:model.lazy="trajet.brands.{{$brand->id}}"
